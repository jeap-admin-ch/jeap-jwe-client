...
- Updated dependencies: `jose` to 6.2.9, the Angular 22 toolchain to 22.1.x, and the
  test and lint tooling. `typescript` and `jasmine-core` stay where the toolchain's peer
